                                                                    ...
                                                                    @foreach ($kpis as $kpi)
                                                                        @foreach ($kpi->kpi_detail as $kpiDetail)
                                                                            <tr>
                                                                                ...
                                                                                @if ($kpiDetail->count_type === 'NON')
                                                                                <td class="text-center">{{ $kpiDetail->value_result == 1 ? '100%' : number_format($kpiDetail->value_result, 2) . '%' }}</td>
                                                                                @elseif ($kpiDetail->count_type === 'RESULT')
                                                                                <td class="text-center">{{ number_format($kpiDetail->value_result * 100, 2) }}%</td>
                                                                                @endif
                                                                            </tr>
                                                                        @endforeach
                                                                    @endforeach
